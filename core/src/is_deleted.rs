...
mod soft_delete {
    use super::*;
    use crate::deletable::{SoftDeletable, SoftDeletableColumn};
    ...
    use ::diesel::{
        ...
        query_dsl::methods::*, AppearsOnTable, Expression, QueryDsl, QueryResult, QuerySource, SelectableExpression,
    };
        ...
        Q: FilterDsl<IsNotNull<<<S as SoftDeletable>::DeletedAt as SoftDeletableColumn>::Column>>,
    {
        fn from(q: Q) -> Self {
            Self(
                q.filter(
                    <<<S as SoftDeletable>::DeletedAt as SoftDeletableColumn>::Column as Default>::default()
                        .is_not_null(),
                ),
                PhantomData,
                PhantomData,
